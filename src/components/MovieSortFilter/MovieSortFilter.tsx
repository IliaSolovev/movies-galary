...
const MovieSortFilter: React.FC<Props> = ({ movieCount, onSetMoviesSortFilter, currentFilter, ...rest }) => {
	const filterButtons = ["release date", "rating"].map((filter: Filters, id) => <FilterButton text={filter} key={id}
