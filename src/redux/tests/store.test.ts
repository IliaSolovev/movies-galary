...
const movie1 = {
  ...
  overview:
    'Believing they have left behind shadowy figures from their past, newlyweds Christian and Ana fully embrace an inextricable connection '
    + 'and shared life of luxury. But just as she steps into her role as Mrs. Grey and he relaxes into an unfamiliar stability, new threats '
    + 'could jeopardize their happy ending before it even begins.',
  budget: 55000000,
  revenue: 136906000,
...
const movie2 = {
  ...
  id: 269149,
  overview:
    "Determined to prove herself, Officer Judy Hopps, the first bunny on Zootopia's police force, jumps at the chance to crack her"
...
describe('actions', () => {
  ...
  it('should set movie sort filter', () => {
