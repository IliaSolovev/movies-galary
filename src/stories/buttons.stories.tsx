...
export const activeFilterButton = () => <FilterButton text="genre" isActive onClick={() => {}} />;
export const searchFilterButton = () => <SearchMovieFiltersButton text="genre" isActive={false} onClick={(e) => {}} />;
export const activeSearchFilterButton = () => <SearchMovieFiltersButton text="genre" isActive onClick={(e) => {}} />;
